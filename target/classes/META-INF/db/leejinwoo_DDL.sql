...
CREATE TABLE RESERVATION(
    ...
    RCHK VARCHAR2(5) NOT NULL
);
SELECT * FROM MEMBER;
SELECT * FROM STORE;
INSERT INTO RESERVATION (RNO, MID, MNAME, MTEL, SNO, SNAME, SOPEN, SCLOSE, STEL, SADDRESS, RDATE, RTIME)
    VALUES (SEQ_R.NEXTVAL, 'aaa', '지코', '010-1234-1234', 1, '군옥각', 10, 20, '070-8888-8888', '리월시 취헌부', SYSDATE, 13);
