		...
		<div id="memberinfo">
			<form action="${conPath }/member/modify.do" method="post"
				...
				<table>
					<tr>
						<td>프로필</td>
						<td><img src="${conPath }/memberImg/${member.mprofile }">
					</tr>
					<tr>
						<td>아이디</td>
						<td>${member.mid }</td>
					...
					<tr>
						...
						<td><input type="text" id="sample4_postcode" name="mpost"
							class="text_box"> <input type="button"
							onclick="sample4_execDaumPostcode()" value="우편번호 찾기"></td>
					</tr>
					<tr>
						<td>주소</td>
						<td><input type="text" id="sample4_roadAddress"
							name="maddress" value="${member.maddress }"> <input
							type="hidden" id="sample4_jibunAddress" name="X"
							placeholder="지번주소"> <span id="guide"></span></td>
					</tr>
					<tr>
						<td>사진수정</td>
						<td><input type="file" name="temp_mprofile"
							value="${member.mprofile }">
					</tr>
					<tr>
						<td colspan="3"><input type="button" value="이전"
							onclick="history.go(-1)" class="btn"> <input
							type="submit" value="정보수정" class="btn"> <input
							type="button" value="회원탈퇴"
							onclick="location.href='${conPath}/member/withdrawal.do'"
							class="btn"></td>
					</tr>
				</table>
			</form>
